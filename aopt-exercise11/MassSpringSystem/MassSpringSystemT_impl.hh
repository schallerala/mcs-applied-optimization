...
namespace AOPT {
    ...
    void MassSpringSystemT<MassSpringProblem>::add_constrained_spring_elements(const int _scenario) {
        ...
        if (_scenario == 1) {
            ...
            msp_.get()->add_constrained_spring_element(get_grid_index(n_grid_x_, n_grid_y_), w, 2 * n_grid_x_,
                                                       2 * n_grid_y_);
    ...
    void MassSpringSystemT<MassSpringProblem>::add_constrained_spring_element_for_center_spring_node() {
        //fix center node
        msp_.get()->add_constrained_spring_element(get_grid_index(n_grid_x_ / 2, n_grid_y_ / 2), 1e5, 2.5 * n_grid_x_,
                                                   n_grid_y_);
    }
    ...
    void MassSpringSystemT<MassSpringProblem>::setup_linear_equality_constraints(SMat &_A, Vec &_b) const {
        ...
        _A.insert(0, 2 * get_grid_index(0, 0)) = 1;
        _b[0] = 0;
        _A.insert(1, 2 * get_grid_index(0, 0) + 1) = 1;
        _b[1] = 0;

        _A.insert(2, 2 * get_grid_index(n_grid_x_, n_grid_y_)) = 1;
        _b[2] = 2 * n_grid_x_;
        _A.insert(3, 2 * get_grid_index(n_grid_x_, n_grid_y_) + 1) = 1;
        _b[3] = 2 * n_grid_y_;

        _A.insert(4, 2 * get_grid_index(n_grid_x_, 0)) = 1;
        _b[4] = 2 * n_grid_x_;
        _A.insert(5, 2 * get_grid_index(n_grid_x_, 0) + 1) = 1;
        _b[5] = 0;

        _A.insert(6, 2 * get_grid_index(0, n_grid_y_)) = 1;
        _b[6] = 0;
        _A.insert(7, 2 * get_grid_index(0, n_grid_y_) + 1) = 1;
        _b[7] = 2 * n_grid_y_;
    }
