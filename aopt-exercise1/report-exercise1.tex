...
\todo{Add space between sections/questions after completing all todos}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \draw[->] (0,0) -- (-2,2);
        \draw[fill]
        (-0.4,1.3) circle [radius=2pt]
        (0.4,0.4) circle [radius=2pt]
        (1,-0.4) circle [radius=2pt];
        \node at (-1.5,1){c};
        \node at (-0.1,1.6){a};
        \node at (0.8,0.3){b};
        \node at (1.3,-0.2){d};
    \end{tikzpicture}
    \todo{ok placement of points?}
\end{figure}
